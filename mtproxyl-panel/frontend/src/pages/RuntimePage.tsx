...
import { GatesSection } from './runtime/GatesSection';
import { InitializationSection } from './runtime/InitializationSection';
import { ConnectionsSection } from './runtime/ConnectionsSection';
import { MEPoolStateSection } from './runtime/MEPoolStateSection';
import { MEQualitySection } from './runtime/MEQualitySection';
import { UpstreamQualitySection } from './runtime/UpstreamQualitySection';
import { NATSTUNSection } from './runtime/NATSTUNSection';
import { MESelfTestSection } from './runtime/MESelfTestSection';
import { StatisticsZeroSection } from './runtime/StatisticsZeroSection';
import { MERuntimeSection } from './runtime/MERuntimeSection';
import { NetworkPathSection } from './runtime/NetworkPathSection';
import { RecentEventsSection } from './runtime/RecentEventsSection';
import type {
  PoolStateData,
  MeQualityData,
  UpstreamQualityData,
...
export function RuntimePage() {
  ...
  const initialization = useEndpoint<InitializationData>(wsData, '/v1/runtime/initialization');
  ...
  return (
    <div>
      <Header
        title="Телеметрия"
        description="Живые показатели движка: маршрут, пул ME, апстримы, NAT и события."
      ...
      <div className="p-4 lg:p-6 space-y-4">
        ...
        {loading ? (
          ...
          <>
            ...
            <InitializationSection data={initialization} />
