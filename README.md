...
последним сообщением. Команды и ответы на вопросы бот убирает из переписки, так
что в истории остаётся только то, к чему возвращаются: ссылки с QR-кодами,
результаты проверок доступности и уведомления. Списки пользователей, трафика и
зондов показываются таблицами.
...
настройки в `config.json` с правами 600. Работает от собственной учётной
