...
| Метрики движка | из `metrics_listen`/`metrics_port` цели, если она их отдаёт; иначе подсказывается, что добавить в конфиг |
...
| Шаг | Описание |
|-----|---------|
| 1 | SYN+ACK с `window=1280` → клиент дробит ClientHello |
