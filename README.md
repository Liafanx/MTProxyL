...
- **Сайт-заглушка из одного каталога.** Движок собирает его снимок при старте и
  ...
  в отдельные читаемые движком файлы: строгая Content Security Policy WEB
  запрещает inline-код. При следующем формировании конфига права уже
  развёрнутых встроенных шаблонов исправляются автоматически.
